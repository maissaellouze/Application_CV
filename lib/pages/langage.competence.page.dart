import 'dart:math';
import 'package:cv_maissa/localisation/locales.dart';
...
class LangageCompetence extends StatefulWidget {
  const LangageCompetence({Key? key}) : super(key: key);

  @override
  State<LangageCompetence> createState() => _ProjetsState();
}

class _ProjetsState extends State<LangageCompetence> {
  int _currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
            LocaleData.option4.getString(context), // Add your desired title
          style: TextStyle(
            color: Colors.white,
            fontSize: 24,
            fontFamily: "Samantha",
...
class OnboardingModel {
  ...
  OnboardingModel(this.desc, this.title,this.image);
}
